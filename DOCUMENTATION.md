...
I used 2 AI agents for the project: Chatgpt for dataset analysis and research, Claude AI for implementing my ideas in the application.

First AI prompt (sent to Chatgpt) used for the dataset:
  - I want you to do full and complete analysis on the dataset attached. Show the trends, correlations, Anomalies and a final review for it.
...
**Station Pareto chart**: A classic quality engineering tool, stations ranked
